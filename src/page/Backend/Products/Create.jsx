                        ...
                        <div className="row">
                            <div className="col-8">
                                <div>
                                    ...
                                    <input onKeyDown={(e) => setError({ ...error, productName: '' })} onChange={(e) => setData({ ...data, "productName": e.target.value })} type="text" id='name' name='name' className='form-control py-3 mb-2' placeholder='Name...' />
                                ...
                                <div>
                                    ...
                                    <input onKeyDown={(e) => setError({ ...error, price: '' })} onChange={(e) => setData({ ...data, "price": e.target.value })} type="number" id='price' className='form-control py-3' placeholder='Name...' />
                                    <span className='text-danger py-2'>{error.price ? error.price : ''}</span>
                                </div>
                                <div>
                                    <label htmlFor="" className='form-label my-3'>category</label>
                                    <SelectBox handleChangeSelect={handleChangeSelect} idName='category' data={category.data?.data} />
                                ...
                                <div>
                                    ...
                                    <textarea onKeyDown={(e) => setError({ ...error, detail: '' })} onChange={(e) => setData({ ...data, "detail": e.target.value })} id='detail' className='form-control py-3' placeholder='detail...' ></textarea>
